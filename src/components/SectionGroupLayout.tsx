// src/components/SectionGroupLayout.tsx
...
export default function SectionGroupLayout({ title, tag, banner, mainImg, mainId, mainTitle, mainTime, cards }: Props) {
    return (
        <div className="w-full flex justify-center mt-[80px] md:mt-[60px] sm:mt-[40px] px-4 sm:px-6">
            <div className="w-full max-w-[1000px] flex flex-col gap-[29px] md:gap-6 sm:gap-4">
                ...
                {/* Banner 1 - Desktop */}
                <div className="hidden sm:block w-full h-[208px] md:h-[180px] sm:h-[150px] overflow-hidden rounded-[8px] md:rounded-[6px] cursor-pointer hover:opacity-95 transition-opacity duration-300">
                    <Link href="/khuyen-mai/mazda" className="block w-full h-full">
                ...
                <div className="w-full flex flex-col lg:flex-row gap-6 md:gap-5 sm:gap-4">
                    ...
                    <div className="w-full lg:w-[488px] flex flex-col gap-4 md:gap-3">
                        <Link href={`/posts/${mainId}`} className="w-full flex flex-col gap-4 md:gap-3 cursor-pointer hover:scale-105 transition-transform duration-300">
                        ...
                        {/* Banner 2 - Mobile */}
                        <div className="block sm:hidden w-full h-[135px] overflow-hidden rounded-[8px] cursor-pointer hover:opacity-95 transition-opacity duration-300">
                            <Link href="/khuyen-mai/mazda" className="block w-full h-full">
                                <img src={banner} className="w-full h-full object-cover" />
                            </Link>
                        </div>
                        ...
                        {/* Banner 2 - Desktop */}
                        <Link href="/khuyen-mai/mazda" className="hidden sm:block">
                            <img src={banner} className="w-full h-[141px] md:h-[120px] sm:h-[100px] object-cover rounded-[8px] md:rounded-[6px] cursor-pointer hover:opacity-97 transition-opacity duration-300" />
                        </Link>
                    </div>
                    ...
                    <div className="flex flex-col gap-4 md:gap-3 w-full lg:flex-1">
                        ...
                        <div className="hidden sm:block">
                            {[0, 1].map((row) => (
                                <div key={row} className="flex gap-6 md:gap-4 sm:gap-3 mb-4 md:mb-3 last:mb-0">
